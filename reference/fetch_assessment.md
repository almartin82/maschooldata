...
Downloads and processes MCAS assessment data from the Massachusetts
...
- grade:
  ...
  Filter by grade level. Options include "03", "04", "05", "06", "07",
  "08", "10", "HS SCI", or "ALL (03-08)". If NULL (default), returns all
  grades.

- subject:

  Filter by subject. Options include "ela", "math", "science",
  "biology", "physics", "civics". If NULL (default), returns all
  subjects.

- subgroup:

  Filter by student subgroup. Use lowercase names like "all", "white",
  "black", "hispanic", "english_learner", "special_ed", etc. If NULL
  (default), returns all subgroups.
...
- exclude_aggregated:
  ...
  If TRUE (default), excludes aggregated grade rows (e.g., "ALL
  (03-08)"). Set to FALSE to include aggregated rows.
...
Data frame with assessment data. Includes columns for end_year, type,
district_id, school_id, grade, subject, subgroup, achievement counts and
percentages, participation rate, scaled score, and student growth
percentiles.
